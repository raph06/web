...
include('classes/class_calendar_etudiant.php');
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js"></script>
			...
			<section>
				<article>
					<h1 style="  margin-left: 95px;  font-family: arial, 'Trebuchet MS', serif, sans-serif; font-weight: normal; text-transform: uppercase; font-size: 1.0em;"> Votre emploi du temps étudiant :</h1> </br>
